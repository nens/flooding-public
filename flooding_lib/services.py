...
def service_get_cutofflocations_from_scenario(
    ...
    return render(request, 'flooding/scenariocutofflocation.json',
...
def service_get_projects(
    ...
    return render(
        request, 'flooding/project.json', {'project_list': project_list})
...
def upload_ror_keringen(request):
    ...
    if f_upload is not None:
        try:
            ...
            return render(
                request,
                template,
                {'message': _('Error on upload.')})
    else:
        return render(
            request, template, {'message': _('Error on upload.')})
    ...
    try:
        ...
        return render(request, template, {'message': _('Error on save.')})

    return render(request, template, {'message': _('Uploaded.')})
...
def get_raw_result_scenario(request, scenarioid):
    ...
    return render(
    request,
        "flooding/results_scenario.html", {
            "results": results
    })
