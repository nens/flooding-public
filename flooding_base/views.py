...
def testdatabase(request, configuration_id):
    ...
    return render(request, 'base/testdatabase.html', d)
...
def service_get_filters(request, configuration_id):
    ...
    return render(request, 'base/filter.json', {'data': data})
...
def service_get_locations(request, configuration_id, filter_id):
    ...
    #print location_dict
    return render(request, 'base/location.json', {'data': location_array})
...
def service_get_parameters(request, configuration_id, filter_id,
    ...
    return render(request, 'base/parameter.json', {'data': parameters})
...
def service_get_location(request, configuration_id, location_id):
    ...
    return render(request, 'base/location_detail.json', {'data': parameters})
...
def service_get_timeseries(request, configuration_id):
    ...
    if request.method == 'GET':
        ...
        #output
        if format == 'json':
            return render(request, 'base/timeseries.json', {'data': result})
        elif format == 'html':
...
def service_get_applications(request):
    ...
    try:
        ...
        pass
    return render(request, 'lizard/application_list.json', {'apps': apps})
...
def gui_config(request):
    ...
    return render(request, 'gui/config.js', {
        'map_list': map_list,
        'user_zoom': user_zoom,
...
def gui_translated_strings(request):
    ...
    return render(request, translated_strings)
...
def help(request):
    ...
    """
    # TODO: move to base?
    return render(request, 'gui/help.html')
...
def userconfiguration(request):
    ...
    """
    # TODO: move to base?
    return render(request, 'gui/configuration.html')
