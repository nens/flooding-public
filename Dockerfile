...
ARG uid=1000
ARG gid=1000
RUN groupadd -g $gid buildout && useradd -lm -u $uid -g $gid buildout

RUN pip install --upgrade pip 'setuptools<45' zc.buildout

VOLUME /srv/flooding.lizard.net
WORKDIR /srv/flooding.lizard.net
USER buildout
